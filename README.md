...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/whoisgit/V2Ray_ws-tls_bash_onekey/dev/install.sh" && chmod +x install.sh && bash install.sh
```
